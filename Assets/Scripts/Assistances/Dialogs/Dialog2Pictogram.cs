/*Copyright 2022 Guillaume Spalla, Louis Marquet, Léri Lamour, Emma Foulon
...
namespace MATCH
{
    namespace Assistances
    {
        namespace Dialogs
        {
            public class Dialog2Pictogram : Dialog2, IPanel2
            {
                ...
                public new void SetTitle(string text, float fontSize = -1.0f)
                {
                ...
                public new void SetDescription(string text, float fontSize = -1.0f)
                {
                ...
                public override void Hide(EventHandler eventHandler, bool withAnimation)
                {
                    ...
                    base.Hide(eventHandler, withAnimation);
